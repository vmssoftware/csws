...
#ifndef AP_SAFE_PATH
#ifdef __VMS
#define AP_SAFE_PATH "/apache$root/000000"
#else
...
#ifdef __VMS
/* Establish the SUEXEC rights identifiers */
#ifndef SUEXEC_SRVR
#define SUEXEC_SRVR     "APACHE$SUEXEC_SRVR"    /* Holder can assume any      */
#endif
#ifndef SUEXEC_USER
#define SUEXEC_USER     "APACHE$SUEXEC_USER"    /* Holder can be assumed by   */
#endif
#endif
