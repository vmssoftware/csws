...
#endif
#if APR_HAS_VMSDLM_SERIALIZE                            /* __VMS */
# define AP_LIST_VMSDLM_SERIALIZE ", 'vmsdlm'"
#else
# define AP_LIST_VMSDLM_SERIALIZE
#endif
...
#define AP_ALL_AVAILABLE_MUTEXES_STRING                  \
    ...
    AP_LIST_SEM_SERIALIZE     AP_LIST_VMSDLM_SERIALIZE          /* __VMS */
