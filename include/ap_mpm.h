...
** VMS Process types
*/
#define AP_MPMQ_IS_CONTROL_PROCESS   130  /* Process is control type      */
#define AP_MPMQ_IS_PARENT_PROCESS    140  /* Process is parent type       */
#define AP_MPMQ_IS_CHILD_PROCESS     150  /* Process is child type        */

/*
** VMS Manage Process states
*/
#define AP_MPMQ_CONTROL_STATE        160  /* MPM Control state            */
#define AP_MPMQ_CONTROL_START         10  /* MPM in start state           */
#define AP_MPMQ_CONTROL_RESTART       20  /* MPM in restart state         */
#define AP_MPMQ_CONTROL_GRACEFUL      30  /* MPM in graceful state        */
#define AP_MPMQ_CONTROL_STOP          40  /* MPM in stop state            */
#define AP_MPMQ_CONTROL_FLUSH         50  /* MPM in flush log state       */
#define AP_MPMQ_CONTROL_NEW           60  /* MPM in new log state         */

/*
** VMS Parent Process id
*/
#define AP_MPMQ_PARENT_PID           170  /* MPM Parent PID               */

/*
** VMS Child Process slot
*/
#define AP_MPMQ_CHILD_SLOT           180  /* MPM Child slot               */

/*
** VMS Server tag
*/
#define AP_MPMQ_SERVER_TAG           190  /* MPM Server tag               */
#endif
