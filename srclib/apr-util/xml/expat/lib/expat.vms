...
/*
** Define truncated routine names
*/                                                                            
#define XML_SetExternalEntityRefHandlerArg      XML_SetExternEntityRefHandlrArg
#define XML_SetUnparsedEntityDeclHandler        XML_SetUnparsedEntityDeclHandlr
#define XML_SetProcessingInstructionHandler     XML_SetProcessingInstructHandlr
#define XML_SetStartNamespaceDeclHandler        XML_SetStartNameSpaceDeclHandlr
