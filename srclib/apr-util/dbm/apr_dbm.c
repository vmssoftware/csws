...
#elif APU_USE_VDBM                              /* __VMS */
#define DBM_VTABLE apr_dbm_type_vdbm            /* __VMS */
#define DBM_NAME   "vdbm"                       /* __VMS */
...
#endif
#if APU_HAVE_VDBM                                                       /* __VMS */
        if (*type == 'V' || *type == 'v') *vtable = &apr_dbm_type_vdbm;
#endif
