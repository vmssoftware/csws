...
$
$!!! >>> TBD pipe run gen_test_char.EXE | type/output=[-.include.private]apr_escape_test_char.h sys$input
$ purge/log [-...]
$
...
$ cc'ccopt' ipv6.c
$ cc'ccopt' vmsshm.c
$!!! >>> TBD cc'ccopt' protshr.c+sys$library:sys$lib_c.tlb/lib
$ cc'ccopt' protshr.c+x86$library:sys$lib_c.tlb/lib
$ cc'ccopt' getpids.c
...
$ cc'ccopt' list.c
$ cc'ccopt' sb_cache.c
$!!! >>> TBD cc'ccopt' vms_stat.c+sys$library:sys$lib_c.tlb/lib
$ cc'ccopt' vms_stat.c+x86$library:sys$lib_c.tlb/lib
$
...
$ lib/insert libapr_vms.olb hash.obj
$ lib/insert libapr_vms.olb list.obj
$ lib/insert libapr_vms.olb sb_cache.obj
