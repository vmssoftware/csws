...
#ifdef __VMS
/*
** Define the extra OpenVMS stat field values
*/
#define APR_FINFO_RFM    0x04000000  /* OpenVMS RMS Record Format       */
#define APR_FINFO_RAT    0x08000000  /* OpenVMS RMS Record Attributes   */
#define APR_FINFO_FSZ    0x10000000  /* OpenVMS RMS File Size           */
#define APR_FINFO_MRS    0x20000000  /* OpenVMS RMS Maximum Record Size */
#endif
...
#ifdef __VMS
    /** Extra fields retrieved from RMS */
    char          fab_rfm;
    char          fab_rat;
    char          fab_fsz;
    char          fab_fill;     /* keep it aligned */
...
#ifdef __VMS
#include <stat.h>
extern int apr$stat (char *FileName, stat_t *StatBuffer, ...);
#endif
