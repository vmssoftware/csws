...
#ifdef __VMS
#define APR_USE_VMSDLM_SERIALIZE 	  1
#endif
...
#endif
#ifdef __VMS
#define APR_HAS_VMSDLM_SERIALIZE 	  1
#endif
...
#if !APR_HAVE_STRUCT_RLIMIT && defined(__VMS)
typedef int rlim_t;
struct rlimit
    {
 ...
 */
#ifdef __VMS
#define APR_FILES_AS_SOCKETS      0 	/* Need to re-visit -- BRC */
#else
