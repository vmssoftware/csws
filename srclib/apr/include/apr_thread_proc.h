...
#ifdef __VMS
extern int apr$asl_create (int server_limit);
extern int apr$asl_insert (pid_t pid);
extern int apr$asl_update (pid_t pid, int status);
extern int apr$asl_delete (void);
extern pid_t apr$asl_waitpid (pid_t pid, int *status_location, int options);
#endif
