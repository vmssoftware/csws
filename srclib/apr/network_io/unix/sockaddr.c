...
#ifdef __VMS
static apr_status_t find_ipv6_addresses(apr_sockaddr_t **sa,
#else
...
// __VMS #else /* end of HAVE_GETADDRINFO code */
#endif /* __VMS */

#if !defined(HAVE_GETADDRINFO) || defined(__VMS)
...
#endif /* end of !HAVE_GETADDRINFO code */      /* __VMS */
...
#if defined(HAVE_GETADDRINFO) && defined(__VMS)
        if (apr$ipv6_started ())
            return find_ipv6_addresses(sa, hostname, family, port, flags, p);
        else
#endif
