$!
$!------------------------------------------------------------------------------
$! OPENSSL_CONF_UTIL.COM - OpenSSL Configuration Utility procedure
$!------------------------------------------------------------------------------
$!
$ Verify = F$VERIFY (0)
$ Set NoOn
...
$!------------------------------------------------------------------------------
$!
$! This procedure gets or sets a given key item in a OpenSSL configuration file.
$! The parameters used are:
$!
$! 	P1	- OpenSSL Configuration File
$! 	P2	- OpenSSL Configuration Function (i.e. GET/SET)
$! 	P3	- OpenSSL Configuration Key/Item (delimited by '#')
$! 	P4	- OpenSSL Configuration Key/Item Value (for SET function only)
$!
$!------------------------------------------------------------------------------
$! Define symbols
$!------------------------------------------------------------------------------
