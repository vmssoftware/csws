$!
$!------------------------------------------------------------------------------
$! OPENSSL_PICK_FILE.COM - OpenSSL Pick File procedure
$!------------------------------------------------------------------------------
$!
$ Verify = F$VERIFY (0)
$ Set NoOn
...
$ Set Control=Y
$!
$ DRAW_BOX := @OPENSSL_COM:OPENSSL_DRAW_BOX
$ FILL_BOX := @OPENSSL_COM:OPENSSL_FILL_BOX
$!
