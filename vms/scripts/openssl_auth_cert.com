$!
$!------------------------------------------------------------------------------
$! OPENSSL_AUTH_CERT.COM - OpenSSL Certificate Authority procedure
$!------------------------------------------------------------------------------
$!
$ Verify = F$VERIFY (0)
$ Set NoOn
...
$!
$ TEXT = "Create Certificate Authority"
...
$ WRITE OFILE "$ OPENSSL req -config ''OPENSSL_CONF_FILE' -new -x509 -days ''_default_days' -keyout ''_default_keyfile' -out ''_default_crtfile'"
...
$!
$ DELETE/NOLOG/NOCONFIRM SYS$LOGIN:OPENSSL_REQ_'PID'.RND;*
...
$!
$     SAY ESC + "[''MSG_ROW';01H''CEOS'"
$     SHOW_FILE "SYS$LOGIN:OPENSSL_X509_''PID'.LOG" 'X1' 'Y1' 'X2' 'Y2' "< ''_default_crtfile' >" 
$     DELETE /NOLOG /NOCONFIRM SYS$LOGIN:OPENSSL_X509_'PID'.LOG;*
$     GOTO EXIT
$ ENDIF
$!
