$!
$!------------------------------------------------------------------------------
$! OPENSSL_SIGN_CERT.COM - OpenSSL Sign Certificate Request procedure
$!------------------------------------------------------------------------------
$!
$ Verify = F$VERIFY (0)
$ Set NoOn
...
$ OPENSSL_CONF_FILE = F$TRNLMN ("OPENSSL_CA_CONF")
...
$ _default_ca_upd = "Y"
$!
$ _default_serfile = "OPENSSL_ROOT:[DB]SERIAL.TXT"
$ _default_serfile_upd = "Y"
$!
$ _default_idxfile = "OPENSSL_ROOT:[DB]INDEX.TXT"
$ _default_idxfile_upd = "Y"
$!
$ _default_crtfile = "OPENSSL_ROOT:[CRT]SERVER_CA.CRT"
$ _default_crtfile_upd = "Y"
$!
$ _default_keyfile = "OPENSSL_ROOT:[KEY]SERVER_CA.KEY"
$ _default_keyfile_upd = "Y"
$!
$ _default_csrfile = "OPENSSL_ROOT:[CSR]SERVER.CSR"
$ _default_csrfile_upd = "Y"
$!
$ _default_sgnfile = "OPENSSL_ROOT:[CRT]SIGNED.CRT"
$ _default_sgnfile_upd = "Y"
$!
$ _default_newcert = "OPENSSL_ROOT:[CRT]"
...
$!
$ _x509_nsComment = "OpenSSL Generated Certificate"
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_serfile = F$PARSE (OPENSSL_CONF_DATA,"OPENSSL_ROOT:",,"DEVICE") + -
 		             F$PARSE (OPENSSL_CONF_DATA,"[DB]",,"DIRECTORY") + -
 		             F$PARSE (OPENSSL_CONF_DATA,"SERIAL",,"NAME") + -
 		             F$PARSE (OPENSSL_CONF_DATA,".TXT",,"TYPE") 
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_idxfile = F$PARSE (OPENSSL_CONF_DATA,"OPENSSL_ROOT:",,"DEVICE") + -
 		             F$PARSE (OPENSSL_CONF_DATA,"[DB]",,"DIRECTORY") + -
 		             F$PARSE (OPENSSL_CONF_DATA,"INDEX",,"NAME") + -
 		             F$PARSE (OPENSSL_CONF_DATA,".TXT",,"TYPE") 
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_crtfile = F$PARSE (OPENSSL_CONF_DATA,"OPENSSL_ROOT:",,"DEVICE") + -
 		             F$PARSE (OPENSSL_CONF_DATA,"[CRT]",,"DIRECTORY") + -
 		             F$PARSE (OPENSSL_CONF_DATA,"SERVER_CA",,"NAME") + -
 		             F$PARSE (OPENSSL_CONF_DATA,".CRT",,"TYPE") 
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_newcert = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_days = OPENSSL_CONF_DATA
$         _default_days_upd = "N"
$     ENDIF
$!
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_policy = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_countryName = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_stateOrProvinceName = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_localityName = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_organizationName = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_organizationalUnitName = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_commonName = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _policy_emailAddress = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _default_x509_extensions = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _x509_basicConstraints = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _x509_nsCertType = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _x509_nsComment = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _x509_subjectKeyIdentifier = OPENSSL_CONF_DATA
...
$     IF OPENSSL_CONF_DATA .NES. ""
$     THEN
$         _x509_authorityKeyIdentifier = OPENSSL_CONF_DATA
...
$ SET_USER_DATA "[''_default_ca']#certificate#D#''_default_crtfile'#Certificate File ?#F###''_default_crtfile_upd'#Y#N"
$ SET_USER_DATA "[''_default_ca']#private_key#D#''_default_keyfile'#Certificate Key File ?#F###''_default_keyfile_upd'#Y#N"
$ SET_USER_DATA "[]#default_csrfile#-#''_default_csrfile'#Certificate Request File ?#F###''_default_csrfile_upd'#Y#N"
$ SET_USER_DATA "[]#default_sgnfile#-#''_default_sgnfile'#Signed Request File ?#F###''_default_sgnfile_upd'#Y#N"
...
$ SHOW SYSTEM /FULL /OUT=SYS$LOGIN:OPENSSL_CA_'PID'.RND
$!
$ OPEN /WRITE OFILE SYS$LOGIN:OPENSSL_CA_'PID'.COM
$ WRITE OFILE "$ SET NOON"
$ WRITE OFILE "$ SET MESSAGE /NOFACILITY /NOIDENTIFICATION /NOSEVERITY /NOTEXT"
$ WRITE OFILE "$ DEFINE /USER /NOLOG RANDFILE    SYS$LOGIN:OPENSSL_CA_''PID'.RND"
$ WRITE OFILE "$ DEFINE /USER /NOLOG SYS$ERROR   SYS$LOGIN:OPENSSL_CA_''PID'.LOG"
$ WRITE OFILE "$ DEFINE /USER /NOLOG SYS$OUTPUT  SYS$LOGIN:OPENSSL_CA_''PID'.LOG"
$ WRITE OFILE "$ DEFINE /USER /NOLOG SYS$COMMAND SYS$INPUT"
$ WRITE OFILE "$ OPENSSL ca -config ''OPENSSL_CONF_FILE' -out ''_default_sgnfile' -infiles ''_default_csrfile'"
...
$ CLOSE OFILE
$!
$ @SYS$LOGIN:OPENSSL_CA_'PID'.COM
$!
$ DELETE/NOLOG/NOCONFIRM SYS$LOGIN:OPENSSL_CA_'PID'.RND;*
$ DELETE/NOLOG/NOCONFIRM SYS$LOGIN:OPENSSL_CA_'PID'.COM;*
$!
$ DEFINE /USER /NOLOG SYS$ERROR  NL:
$ DEFINE /USER /NOLOG SYS$OUTPUT NL:
$ SEARCH SYS$LOGIN:OPENSSL_CA_'PID'.LOG /OUT=SYS$LOGIN:OPENSSL_CA_'PID'.ERR "error:"
$ IF F$SEARCH ("SYS$LOGIN:OPENSSL_CA_''PID'.ERR") .NES. "" 
$ THEN 
$     IF F$FILE_ATTRIBUTE ("SYS$LOGIN:OPENSSL_CA_''PID'.ERR","ALQ") .NE. 0
$     THEN 
$         DELETE /NOLOG /NOCONFIRM SYS$LOGIN:OPENSSL_CA_'PID'.ERR;*
$         SAY ESC + "[''MSG_ROW';01H''BELL'''CEOS'"
$         SHOW_FILE "SYS$LOGIN:OPENSSL_CA_''PID'.LOG" 'X1' 'Y1' 'X2' 'Y2' "< ERROR >" 
$         DELETE /NOLOG /NOCONFIRM SYS$LOGIN:OPENSSL_CA_'PID'.LOG;*
$         GOTO EXIT
$     ENDIF
$     DELETE /NOLOG /NOCONFIRM SYS$LOGIN:OPENSSL_CA_'PID'.ERR;*
$ ENDIF
...
$!
$     SAY ESC + "[''MSG_ROW';01H''CEOS'"
$     SHOW_FILE "SYS$LOGIN:OPENSSL_X509_''PID'.LOG" 'X1' 'Y1' 'X2' 'Y2' "< ''_default_sgnfile' >" 
$     DELETE /NOLOG /NOCONFIRM SYS$LOGIN:OPENSSL_X509_'PID'.LOG;*
$     GOTO EXIT
$ ENDIF
$!
...
$!
$ IF F$SEARCH ("SYS$LOGIN:OPENSSL_CA_''PID'.%%%;*") .NES. "" THEN DELETE /NOLOG /NOCONFIRM SYS$LOGIN:OPENSSL_CA_'PID'.%%%;*
