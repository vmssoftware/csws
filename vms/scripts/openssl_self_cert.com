$!
$!------------------------------------------------------------------------------
$! OPENSSL_SELF_CERT.COM - OpenSSL Self Signed Certificate procedure
$!------------------------------------------------------------------------------
$!
$ Verify = F$VERIFY (0)
$ Set NoOn
...
$!
$ _default_crtfile = "OPENSSL_ROOT:[CRT]SERVER.CRT"
...
$ IF F$EDIT (_encrypt_key,"UPCASE") .EQS. "Y"
$ THEN 
$     WRITE OFILE "$ OPENSSL req -config ''OPENSSL_CONF_FILE' -new -days 365 -x509 -keyout ''_default_keyfile' -out ''_default_crtfile'"
$     WRITE OFILE "''_pem_pass_phrase'"
$     WRITE OFILE "''_pem_pass_phrase'"
$ ELSE
$     WRITE OFILE "$ OPENSSL req -config ''OPENSSL_CONF_FILE' -nodes -new -days 365 -x509 -keyout ''_default_keyfile' -out ''_default_crtfile'"
$ ENDIF
$ WRITE OFILE ""
$ WRITE OFILE ""
$ WRITE OFILE ""
