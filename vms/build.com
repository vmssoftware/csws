...
$ ccopt = "/names=(as_is,shortened)/nolist/show=all/define=(LDAP_DEPRECATED=1,_SOCKADDR_LEN,HAVE_CONFIG_H,_REENTRANT,_USE_STD_STAT,_LARGEFILE)/include=cc$include/warn=disable=(QUESTCOMPARE,QUESTCOMPARE1)"
$
$ purge/log [-...]
...
$ pipe run gen_test_char.EXE | type/output=test_char.h sys$input
$ delete/log/noconf gen_test_char.exe;*
$ purge/log [-...]
$
$ cc'ccopt' [-.server]ssl.c
...
$
$ delete/log/noconf test_char.h;*
$
$ lib/create libmain.olb
$ purge/log
$
$ lib/insert libmain.olb ssl.obj
...
[-.srclib.apr.vms]apache$apr_shr.exe/share
$
$ cc'ccopt' [-.support]suexec.c+sys$library:sys$lib_c.tlb/lib
...
[-.srclib.apr.vms]apache$apr_shr.exe/share
$
$ cc'ccopt' apache$dcl_run.c+sys$library:sys$lib_c.tlb/lib
...
$
$ cc'ccopt' hostaddr.c+sys$library:sys$lib_c/library
$ link/exe=hostaddr.exe hostaddr.obj
$
$ cc'ccopt' hostname.c+sys$library:sys$lib_c/library
...
$
$
$ link/exe=apache$httpd.exe libmain.olb/include=("main"),sys$input/opt
...
$! Modules...
$ modules:
$ ccopt = "/names=(as_is,shortened)/nolist/define=(LDAP_DEPRECATED=1,_SOCKADDR_LEN,OPENSSL_NO_SRP,HAVE_CONFIG_H,_REENTRANT,_USE_STD_STAT,_LARGEFILE)/include=cc$include/warn=disable=(QUESTCOMPARE,QUESTCOMPARE1)"
$
$! ----------------------------------------------------------------------
$! Aaa...
$ define cc$include [-.os.unix],[-.include], -
...
$
$ cc'ccopt' [-.modules.cache]mod_socache_redis.c
$ link/share=mod_socache_redis.exe mod_socache_redis.obj,sys$input/opt
sys$disk:[-.srclib.apr.vms]apache$apr_shr.exe/share
sys$disk:[-.srclib.apr-util.vms]apache$apu_shr.exe/share
sys$disk:[]apache$httpd_shr.exe/share
CASE_SENSITIVE=YES
SYMBOL_VECTOR=(socache_redis_module=DATA)
$
$ purge/log
$ delete/log/noconf *.obj;*
$
...
SYMBOL_VECTOR = ( -
	...
	proxy_hook_check_trans = PROCEDURE)
!
$
...
$
$ if "''platform'" .eqs. "IA64"
$ then
$    set def [.modules.mod_wsgi.src.server]
$    @build.com
$    set def [----]
$ endif
$
...
$    product package -
/format=sequential -
/source=httpd_axp.pcsi$desc -
/destination=[] -
/opt=noconfirm -
/material=([],[-],[.scripts],[-.docs.conf],[-.docs.conf.extra],[.docs.cgi-examples],[-.srclib.apr.vms],[-.srclib.apr-util.vms],ssl111$root:[alpha_exe]) -
csws
$ else
$    product package -
/format=sequential -
/source=httpd.pcsi$desc -
/destination=[] -
/opt=noconfirm -
/material=([],[-],[.scripts],[-.docs.conf],[-.docs.conf.extra],[.docs.cgi-examples],[-.srclib.apr.vms],[-.srclib.apr-util.vms],ssl111$root:[ia64_exe]) -
csws
$ endif
$
$
