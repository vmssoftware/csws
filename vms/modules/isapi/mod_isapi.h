...
#define WINAPI
#endif
#ifdef __NO_APR_DEFS__
#ifndef APR_THREAD_FUNC
#define APR_THREAD_FUNC
#define apr_os_file_t int
#define apr_uint32_t unsigned int
#endif
#endif
 ...
 */
unsigned int APR_THREAD_FUNC GetExtensionVersion(HSE_VERSION_INFO *ver_info);
